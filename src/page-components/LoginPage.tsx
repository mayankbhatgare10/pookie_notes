...
export default function LoginForm() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast('Welcome back, Pookie! 🎉', 'success');
  ...
  return (
    <div className="min-h-screen bg-[#fffef0] flex items-center justify-center px-4 animate-fade-in">
      <div className="w-full max-w-sm animate-scale-in">
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={handleLogin}
            disabled={loading}
            className="w-full py-4 rounded-[32px] bg-[#ffd700] hover:bg-[#ffed4e] border-[3px] border-black text-black font-bold text-base transition-all duration-200 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] flex items-center justify-center gap-2 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 rounded-full bg-white hover:bg-gray-50 border-2 border-black text-black font-normal text-sm transition-colors flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <div className="text-center text-sm text-[#8b7355] mt-6">
            ...
            <Link href="/signup" className="text-black font-bold hover:underline">Sacrifice your soul here</Link>
          </div>
