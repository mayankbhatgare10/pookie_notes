            ...
            <div className="flex gap-3 items-center">
                ...
                <div className="inline-flex bg-[#f5f4e8] rounded-full p-1.5">
                    <button
                        ...
                        className={`px-6 py-2 rounded-full font-medium text-sm transition-all ${activeTab === 'all' ? 'bg-white text-black shadow-sm' : 'text-[#666] hover:text-black'}`}
                    >
                        All
                    </button>
                    <button
                        onClick={() => setActiveTab('archived')}
                        className={`px-6 py-2 rounded-full font-medium text-sm transition-all flex items-center gap-1.5 ${activeTab === 'archived' ? 'bg-white text-black shadow-sm' : 'text-[#666] hover:text-black'}`}
                    >
