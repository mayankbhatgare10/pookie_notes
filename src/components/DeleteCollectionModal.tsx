        ...
        <>
            ...
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-2xl shadow-2xl z-[90] p-6 animate-scale-in">
                ...
                <div className="flex items-start justify-between mb-4">
                    ...
                    <button
                        onClick={onClose}
                        className="w-8 h-8 rounded-full hover:bg-[#f5f4e8] flex items-center justify-center transition-colors flex-shrink-0"
                    >
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        className={`flex-1 px-4 py-3 rounded-xl font-bold transition-colors border-2 ${selectedAction === 'delete'
