      ...
      <div className="flex-1 flex items-center justify-center px-6 py-8">
        <div className="w-full max-w-md">
          ...
          <button
            ...
            className="w-full py-3 rounded-full bg-white hover:bg-gray-50 border border-black text-black font-normal text-sm transition-colors flex items-center justify-center gap-3 mb-4"
          >
